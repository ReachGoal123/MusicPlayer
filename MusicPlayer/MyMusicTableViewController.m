...
- (void)viewDidLoad
{
    ...
    self.tabBarController.tabBar.selectionIndicatorImage = [UIImage imageNamed:@"tabbar_selected_back"];
    //self.tabBarController.tabBar.backgroundImage = [UIImage imageNamed:@"tabbar_back"];
